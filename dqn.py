...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    prev_hp, game_win, prev_fame = game_state.get_current()
    x_t, r_0, terminal, prev_hp, prev_fame = game_state.step(do_nothing, prev_hp, prev_fame)
    ...
    while "flappy bird" != "angry bird":
        ...
        x_t1_colored, r_t, terminal, prev_hp, prev_fame = game_state.step(a_t, prev_hp, prev_fame)
